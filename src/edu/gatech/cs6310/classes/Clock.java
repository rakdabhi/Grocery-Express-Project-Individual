...
public class Clock {
     ...
     * NOTE: Integral of above function is: -(518400/π) * sin((π/720)x) + 720x + C
     ...
     * @param startTime - start time of timeframe
     * @param endTime - end time of timeframe
     ...
     * Integral: -(518400/π) * sin((π/720)x) + 720x + C
     * NOTE: Constant 'C' gets cancelled out during integration.
     * @param time - point of time to calculate the amount of daylight
     * @return the amount of daylight at the given time
     */
    private static double daylightFunc(int time) {
        return -(518400/Math.PI) * Math.sin((Math.PI/720) * time) + (720 * time);
    }
}
